...
| Control                                                      |       􀆍       |
| Return                                                       |       􀅇       |
| <table>  <thead>    <tr>      <th rowspan="2">分类代号</th>      <th rowspan="2">制造方式</th>      <th colspan="2">钢管尺寸</th>      <th rowspan="2">允许偏差 (普通级)</th>      <th rowspan="2">允许偏差 (高级)</th>    </tr>    <tr>      <th>公称外径(D)</th>      <th>公称壁厚(S)</th>    </tr>  </thead>  <tbody>    <tr>      <td rowspan="9">W-H</td>      <td rowspan="5">热轧(挤压)钢管</td>      <td>&lt;57</td>      <td rowspan="5"></td>      <td>±0.4</td>      <td>±0.3</td>    </tr>    <tr>      <td>57~325, S≤35</td>      <td>±0.75%D</td>      <td>±0.5%D</td>    </tr>    <tr>      <td>57~325, S&gt;35</td>      <td>±1%D</td>      <td>±0.75%D</td>    </tr>    <tr>      <td>&gt;325~600</td>      <td>允许偏差: ±1%D 或 +5, 取较小者<br>允许下偏差: -2</td>      <td></td>    </tr>    <tr>      <td>&gt;600</td>      <td>允许上偏差: ±1%D 或 +7, 取较小者<br>允许下偏差: -2</td>      <td></td>    </tr>    <tr>      <td rowspan="4">热轧斜轧钢管</td>      <td></td>      <td>≤4.0</td>      <td>±0.4</td>      <td>±0.4</td>    </tr>    <tr>      <td></td>      <td>4.0~20, D&lt;219</td>      <td>±12.5%S</td>      <td>±10%S</td>    </tr>    <tr>      <td></td>      <td>&gt;20, D&lt;219</td>      <td>±10%S</td>      <td>±7.5%S</td>    </tr>    <tr>      <td></td>      <td>&gt;20, D≥219</td>      <td>±12.5%S</td>      <td>±10%S</td>    </tr>    <tr>      <td rowspan="3">W-C</td>      <td rowspan="3">冷拔(轧)钢管</td>      <td>25.4~40</td>      <td></td>      <td>±0.2</td>      <td>-</td>    </tr>    <tr>      <td>&gt;40~50</td>      <td></td>      <td>±0.25</td>      <td>-</td>    </tr>    <tr>      <td>&gt;50~60</td>      <td></td>      <td>±0.3</td>      <td>-</td>    </tr>    <tr>      <td></td>      <td></td>      <td>&gt;60</td>      <td></td>      <td>±0.5%D</td>      <td>-</td>    </tr>    <tr>      <td></td>      <td></td>      <td></td>      <td>≤3.0</td>      <td>±0.3</td>      <td>±0.2</td>    </tr>    <tr>      <td></td>      <td></td>      <td></td>      <td>&gt;3.0</td>      <td>±10%S</td>      <td>±7.5%S</td>    </tr>  </tbody>``~~··````·····</table> |       􀆛       |
| 向后删除键                                                   |       􀆗       |
| 上箭头键                                                     |       􀄨       |
| 下箭头键                                                     |       􀄩       |
| 左箭头键                                                     |       􀄪       |
...
<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
    <rect width="1024" height="1024" rx="96" fill="#15E"/>
    <!--<circle cx="512" cy="512" r="448" fill="#FFF"/>-->
    <circle cx="512" cy="512" r="320" fill="#F24"/>
    <g fill="none" stroke="#FFF" stroke-width="72" stroke-linecap="round" stroke-linejoin="round">
        <path d="M 512 192 L 512 832"/>
        <path d="M 192 256 L 512 832"/>
        <path d="M 832 256 L 512 832"/>
    </g>
    <circle
            cx="512" cy="512" r="384"
            fill="none"
...
<h2 align='center' style='color:#1EB'>这是青绿 #1EB</h2>
<h2  style='background:#1EB'></h2>
<h2 align='center' style='color:#E07'>这是紫红 #E07</h2>
<h2  style='background:#E07'></h2>
<h2 align='center' style='color:#3DE'>这是湖蓝 #3DE</h2>
<h2  style='background:#3DE'></h2>
<h2 align='center' style='color:#8DC'>这是蒂芙尼 #8DC</h2>
<h2  style='background:#8DC'></h2>
...
<h2 align='center' style='color:#4D9'>这是绿色 #4D9</h2>
<h2  style='background:#4D9'></h2>
<h2 align='center' style='color:#29F'>这是蓝色 #29F</h2>
<h2  style='background:#29F'></h2>
<h2 align='center' style='color:#0AD'>这是孔雀蓝-宝蓝色 #0AD</h2>
<h2  style='background:#0AD; color:#FFF'>Dodger Blue</h2>
...
| 按单词后移         | Alt + F          |                                                              |
| **历史搜索**       |                  | **History**                                                  |
| **反向搜索**       | Ctrl + R         | Search history backwards<br/>, enter键选择命令               |
...
| 退出               | Ctrl+D           | Log out of the current session (same as typing 'exit')<br />EOF, 文件结束符, 通常用于退出交互式程序或者告诉终端你已经输入完了 |
| **其他技能**       |                  | **Miscellaneous**                                            |
| Tab                | Ctrl + I         |                                                              |
...
And Github also does not provide any `i18n` solution for this. One current workaround is to [Add Custom CSS](https://support.typora.io/Add-Custom-CSS/). For example, to change the word “Note” to Chinese version “注意”：
...
```css
body {
    font-family: "SF Mono", "Droid Sans Mono","Helvetica Neue", Helvetica, Arial,  "Open Sans", "Clear Sans", 'Segoe UI Emoji', sans-seri, 'SF Pro', system-ui, ui-monosapce;
    color: rgb(51, 51, 51);
    line-height: 1.6;
    --monospace: "SF Mono", "Droid Sans Mono", "Liberation Mono", Consolas ,monospace, ui-monospace /* for all code blocks, inline code, and source code mode */

}
/* 重点是'SF Pro', system-ui */
```
...
[链接本地文件](file:///Users/wwfyde/.zshr)  支持绝对路径和相对路径使用`file://`时, 用默认应用程序打开
...
```text
插入视频链接
<video src="my_video.mkv" />
<video src="/Users/<username>/videos/my_video.mkv" />
```
...
[跳转到别的文件的标题](Python程序设计语言.md/#专业术语)

[**跳转到标题**](#PyCharm)

[点击跳转 - 方法一 markdown风格](#目标路径)

<a href="Python程序设计语言/#专业术语">方法二标准html模式</a>
...
<a href='Python程序设计语言.md/#专业术语'>方法二标准html模式</a>
...
<div style="display:flex; gap:1rem; align-items:flex-start; flex-wrap:wrap;">
  <div style="flex:1; min-width:260px;">块 1</div>
  <div style="flex:1; min-width:260px;">块 2</div>
</div>
...
- ~~使用`option+shift+enter`来选择导入的对象~~
...
[suppress-inspection](https://www.jetbrains.com/help/pycharm/disabling-and-enabling-inspections.html#suppress-inspections)

当自动优化代码时, 可能出现某段导入被删除, 可以使用 `# noqa` 或 `noinspection`的方式来避免被优化
...
这种情形通常是因为`.venv`目录没在project_root目录下, 出现在子目录, 显示的标记该目录为exclude目录即可让代码提示恢复正常
...
# 然后删除缓存
File->invalitDate Caches/Restart
```
...
| 查看错误描述                       |                            cmd+F1                            | error  description                                 |
| 覆盖(重写)方法                     |                             ^+O                              |                                                    |
| 实现方法                           |                          control+I                           |                                                    |
| **优化导入**                       |                       control+option+O                       | optimize import                                    |
| 自动缩进行                         |                       control+option+I                       |                                                    |
| 从缓冲区粘贴                       |                         cmd+shift+V                          |                                                    |
| 智能将代码拼成一行                 |                            􀆍+􀆝+J                             |                                                    |
| 智能拆分拼接的行                   |                           􀆔+enter                            |                                                    |
| 大小写切换                         |                            􀆔+􀆝+U                             |                                                    |
...
| 折叠所有代码                       |                          􀆔+􀆝+`-/+`                           |                                                    |
| 从工具窗口进入代码文件窗口         |                             esc                              |                                                    |
| **重新从磁盘加载<br />同步或刷新** |                            􀆔+􀆕+Y                             | Reload All from Disk                               |
| 隐藏所有工具窗口                   |                           􀆔+􀆝+F12                            |                                                    |
| **检查当前文件**                   |                            􀆕+􀆝+I                             |                                                    |
| **切换器**                         |                            􀆍+Tab                             | switcher                                           |
| **上个编辑处**                     |                          􀆔+􀆝+delete                          | Last Edit Location                                 |
| 调用层次结构                       |                            􀆍+􀆕+H                             |                                                    |
| 显式类UML图                        |                            􀆔+􀆕+U                             |                                                    |
| 优化导入                           |                        ctrl+option+O                         | optimize imports                                   |
| 选中多行                           |                          shift + up                          |                                                    |
| 补全本行                           |                     cmd + shift + return                     |                                                    |
| 多选                               |                           ctrl + G                           |                                                    |
| 全选选中的变量                     |                        cmd + ctrl +G                         |                                                    |
...
| 问题(github) | <kbd>Cmd</kbd>+<kbd>Ctrl</kbd>+<kbd>I</kbd>                | Inspect Code Problem<br />手动触发问题代码检查 |

### copilot

| function        | shortcut     | descriptiom |
| --------------- | ------------ | ----------- |
| show completion | opt+\        |             |
| insert          | tab          |             |
| next completion | opt+]        |             |
| apply next word | cmd+`→`      |             |
| apply next line | ctrl+cmd+`→` |             |

### debug

### picture

![image-20231128143054483](https://wwfyde.oss-cn-hangzhou.aliyuncs.com/images/202311281430691.png)
...
| **查看对象定义**                       |                      | Ctrl + B / F4                                                |
| 注释代办任务                           |                      | \#   TODO(name) 注释的内容<br /># TODO(name): content                         |
| 删除当前行                             |                      | Ctrl + Y                                                     |
| 剪切/复制/粘贴                         |                      | Ctrl + X / C / V                                             |
| 单步执行                               |                      | F8 /F7                                                       |
| F8                                     |                      | 单步执行, 但是不执行子函数                                   |
...
- 实用 menu |tools | html client 替代postman
    - 或者使用 requests , httpx 登录接口

## 调试模式

> `debug`    `debugger`    `调试器`

非暂停日志断点(Non-Suspending Logging Breakpoint)

| 功能                                                         | pycharm                              |                      | 快捷键           |
| ------------------------------------------------------------ | ------------------------------------ | -------------------- | ---------------- |
| 调试模式                                                     |                                      | Debug                | Shift + F9       |
| 中断后继续(重新开始)<br />执行到下一个断点                   |                                      | **Resume**           | F9               |
| 恢复执行直到到下一断点                                       | 恢复程序                             | Resume Program       | F9               |
|                                                              | 暂停程序                             | pause Program        |                  |
| 显示执行指针                                                 |                                      | Show Execution Point | Alt + Shift + 0  |
| 单步执行(不进入函数)<br />对当前函数逐行执行, 但不会进入每一行的函数内部 | 步过                                 | Step Over            | F8               |
| 逐步执行<br />如果当前行包含一个函数调用，<br />Step Into 将进入该函数内部，<br />并在函数的第一行停止。<br />当你需要查看函数内部的具体实现和执行细节时，<br />使用 Step Into 可以深入到函数内部。 | 步入                                 | Step Into            | F7               |
| 逐步执行当前代码<br />类似于 Step Into，但只进入你自己写的代码，<br />忽略库代码或其他非项目代码。<br />当你只关心项目代码的执行流程，<br />而不想深入第三方库或框架的内部实现时，<br />使用这个功能可以避免跳入对调试无关紧要的代码。 | 个人代码间步入<br />单步执行我的代码 | Step Into My Code    | Alt + Shift + F7 |
| 逐步跳出<br />从当前函数中跳出(跳过函数的剩余代码)，<br />返回到函数被调用的地方，<br />并停在调用该函数的下一行代码。<br />执行到返回主调函数为止, <br />并准备执行函数的下一行 | 步出                                 | Step Out             | Shift + F8       |
| 查看断点                                                     | 查看断点                             | view breakpoint      |                  |
| 忽略断点                                                     | 忽略断点                             | mute breakpoint      |                  |
| 执行到光标处                                                 |                                      | Run To Cursor        | Alt + Shift + 9  |
| 评估语句(添加代码碎片)                                       |                                      | Evaluate Expression  | Alt + Shift + 8  |
| **条件断点**<br />edit breakpoint<br />当评估表达式为真时才会断点处暂停 |                                      |                      |                  |
| 代码调试中修改代码, 而无需重启代码                           |                                      |                      |                  |
| 日志断点                                                     |                                      |                      |                  |
...
支持ssh jump 需要注意 连接名称与`~/.ssh/config`匹配: 比如应该填写 `181` 而不是`192.168.0.181`
...
| ------------------------- | ------------------------------- | -------------------- | ------------------- |
| Cmd+Shift + P             | cmd+shift+A<br />ctrl+alt+space | 快速命令             | Show all Command    |
| Cmd                       | Cmd + Shift + O                 | 快速搜索或快速打开   | Quick Open          |
| **Ctrl + Button 1 click** | ctrl+J                          | **查看代码文档提示** | Show or Focus Hover |
...
- 控制界面大小, zoomLevel, 0即可

## 插件

### General

- <del>vscode-icons: 图标主题</del>
- wwfyde: 颜色主题
- Monokai: 颜色主题
- draw.io - 流程图工具
- setting sync - 配置同步工具
...
The Vite + React + TypeScript sources live in `src/`, with feature-oriented folders: UI primitives in `src/components`, routed views in `src/pages`, shared hooks and helpers under `src/lib`, `src/contexts`, and `src/utils`, and API contracts in `src/api` and `src/services`. Static assets belong in `public/`, while `examples/` holds optional reference usage. Build artifacts are emitted to `dist/`; keep this directory out of commits.

## Build, Test, and Development Commands

Install dependencies with `pnpm install`. During development run `pnpm dev` (Vite on http://localhost:6001). Use `pnpm build` for a production bundle, `pnpm preview` to inspect it locally, and `pnpm prod` when you need both build and preview in one step. `pnpm start` serves the existing `dist/` output on port 6002. Run `pnpm lint` before pushing and `pnpm format` to rewrite files using the shared Prettier rules.

## Coding Style & Naming Conventions

This repo relies on ESLint (`eslint.config.js`) and Prettier (`prettier.config.js`) with Tailwind-aware plugins. Let both tools dictate spacing (2-space indent), quotes (single for JS/TS, double for JSX), and import ordering. Use PascalCase for React components (`Button.tsx`), camelCase for functions and variables (`fetchUserProfile`), SCREAMING_SNAKE_CASE for constants, and kebab-case for file names that export hooks or utilities (`use-auth.ts`). Prefer TypeScript types/interfaces in `src/models` for shared contracts.

## Testing Guidelines

Automated testing is not wired up yet, so new features should ship with either lightweight browser-based verification steps or a proposed testing setup (Vitest + Testing Library is the expected stack). When you introduce tests, mirror the folder under `src/` (e.g., `src/components/Button/Button.test.tsx`) and document how to run them in your PR.

## Commit & Pull Request Guidelines

There is no existing git history, so adopt Conventional Commits (`feat:`, `fix:`, `refactor:`) to keep the log searchable. Keep commits scoped and include rationale when touching generated files like `components.json`. Pull requests must describe the change, list manual or automated verification, link issues when applicable, and attach UI screenshots or recordings for visual updates. Request review from at least one maintainer before merging.

## Environment Notes

Vite environment variables use the `VITE_` prefix; add new keys to `.env.example` and document usage. Tailwind is configured via `components.json` and `@tailwindcss/cli`; rerun the build whenever you change design tokens to keep generated CSS in sync.
```
...
This monorepo is managed with `uv` and Hatch. Core packages live in `api/` and `lib/`; the former exposes the CLI entry point in `api/src/api/main.py`, while `lib/src/lib/` holds shared configuration and utilities. Example agents and experiments sit in `sam2_app/`, `standalone-project/`, and `examples/`. Place all new automated checks inside `tests/`, mirroring the package layout you are validating.

## Build, Test, and Development Commands

Run `uv sync` at the repository root to install or update dependencies declared across the workspace. Use `uv run python main.py` for the default scaffold, `uv run python -m api.main` for the packaged API stub, and `uv run python sam2_app/main.py` when iterating on the example agent. Execute `uv run pytest` from the root to validate the full test suite once tests have been added.

## Coding Style & Naming Conventions

Target Python 3.12, four-space indentation, and comprehensive type hints; lean on Pydantic models and settings (see `lib/src/lib/config.py`) to keep configuration declarative. Stick to snake_case for modules, functions, and variables, PascalCase for classes, and UPPER_SNAKE_CASE for constants. Group related configuration files by environment using the existing `config.*.toml` naming, and document any new settings via field metadata.

## Testing Guidelines

Author tests with `pytest` under `tests/`, naming files `test_<module>.py` and test functions `test_<behavior>`. Mirror the runtime package structure so imports stay relative. When integration tests require external services (e.g., Redis, Midjourney), guard them with markers such as `@pytest.mark.integration` and supply mocked clients in unit tests.

## Commit & Pull Request Guidelines

The current checkout lacks shared history, so follow Conventional Commits (`feat:`, `fix:`, `chore:`) to keep future logs structured. Include scope when helpful (`feat(lib): ...`). Reference issues in the body, enumerate changes, and note any new configuration files or required secrets. Before requesting review, ensure `uv sync` and `uv run pytest` succeed locally, and attach screenshots or logs for user-facing changes.

## Configuration & Secrets

The settings layer composes environment variables, `.env`, and layered TOML files; load-sensitive values (tokens, keys) must stay out of version control and be injected via environment variables. When adding new clients, extend `lib.config.Settings` with typed Pydantic models so downstream agents can rely on validation rather than manual parsing.
```
...
The workspace centers on the Axum API service backed by shared crates. Key directories: `api/` (Axum server, route handlers, service layer), `entity/` (SeaORM models), `migration/` (SeaORM migrations), `crates/object_storage/` (experimental storage client), and `examples/` (Axum samples for reference). Configuration lives in `config/*.toml` with checked-in variants for local setups. Use `data/` and `dvdrental/` for seed fixtures, and keep new binaries under `api/src/bin/` to stay aligned with current layout.

## Build, Test, and Development Commands

- `cargo run -p api` starts the primary service using workspace defaults.
- `cargo test --workspace` executes unit tests across crates; add `-- --nocapture` when debugging configuration loaders.
- `cargo fmt` and `cargo clippy --workspace --all-targets` ensure formatting and lint compliance before review.
- `sqlx migrate run` (from `migration/`) applies pending migrations once the `DATABASE_URL` is exported.

## Coding Style & Naming Conventions

Follow Rust 2024 edition defaults: four-space indentation, snake_case for modules and functions, PascalCase for types, and SCREAMING_SNAKE_CASE for constants. Group domain logic under `services/` and HTTP mappings under `routes/` to mirror the existing API layering. Run `cargo fmt` pre-commit; format drift is treated as a review blocker. Prefer explicit module declarations in `src/schemas` so that OpenAPI generation via `utoipa` remains predictable.

## Testing Guidelines

Leverage the built-in `cargo test` runner; integration tests for new endpoints should live under `api/tests/` (create the folder if absent) using `axum::Router` test harnesses. Name test functions with the pattern `test_<behavior>` and cover both happy-path and config failure branches—for example, mirror `config::tests::can_load` when adding new loaders. Maintain minimal seed data in `dvdrental/` to keep tests isolated; document any required fixtures in the test module docstring.

## Commit & Pull Request Guidelines

History uses Conventional Commits (`feat:`, `fix:`, etc.); continue that pattern and keep subject lines under 72 characters. Each PR should summarize scope, list runnable commands (`cargo test`, `sqlx migrate run`), and link to tracking issues where applicable. Include screenshots or sample JSON only when changing externally visible behavior. Request at least one reviewer familiar with the touched crate and note any configuration changes in the PR body so deploy environments can be updated promptly.

## Configuration Tips

Copy `config.example.toml` to `config.toml` for local development, then override secrets through environment variables or a `.env` file consumed by `dotenvy`. When introducing new settings, expose them through `api/src/config.rs` and document defaults inline to keep onboarding straightforward.
```
...
```shell
- try to use packages  from project configuration file, such as  package.json,pyproject.toml,cargo.toml,go.mod;
- load env var from @.env but using it explicitly
- use mock data as documents
- clear, concise summary
-  scalable project layout
- Prefer fuctional, declarative programming
- Use descriptive variable names
- use latest stable major version packages(e.g.: pydantic v2, sqlalchemy v2)
- Prioritize providing solutions rather than code implementations, and focus on the implementation ideas and thinking processes.
- preserve comments when applying changes
- tailwindcss fisrt when applying css 
```
...
# 通用指南
追求简洁和清晰。在此阶段，过度设计是一种负担。
当文件过长（超过 1500 行）时，将其拆分为更小的文件。当函数过长时，将其拆分为更小的函数。确保检查文件当前的用法，以确保新的拆分不会影响代码的功能。
遵循由 Stripe & Basecamp 启发的工程原则：Stripe – 高质量 API 设计，平衡技术优雅性与产品体验。Basecamp – “小团队，大影响”理念，强调清晰性和长期可维护性而非趋势。
...
# UX/UI 指南
以 Airbnb 和 Apple 为灵感，采用最高标准进行设计，确保无缝且直观的用户体验。
减少 UI/UX 中的不必要复杂性——优先考虑可用性和清晰度。
一致性是关键 - 在整个应用程序中保持统一的设计模式、字体和间距。
优先考虑可访问性 - 确保界面对所有用户都是包容的且易于使用
...
# 调试
遵循此结构化顺序，快速识别和解决问题：
广泛假设 - 列出 5-7 个可能的根本原因，包括边缘情况、并发问题和意外依赖。
2. 基于第一性原理进行提炼 - 根据已知系统行为和以往事件，将可能性缩减至 1-2 个最可能的原因。
3. 使用日志验证 - 插入目标日志以跟踪关键数据结构的转换，并在修改代码之前验证假设。
4. 在修复前模拟 - 在可行的情况下，编写小型的模拟场景以独立复现问题。
5. 明确需求 - 如果根本原因与业务逻辑相关，则在做出更改之前，请要求澄清或列出明确的假设。
...
1. 深入理解范围
在规划前阅读相关代码。
- 识别所有下游影响（例如，数据库架构、API 更改、UI 更新、依赖项）。
...
2. 提出 4-6 个关键澄清问题
如果需求模糊，在假设任何内容之前，先提出正确的问题。
- 问题应揭示缺失的细节、潜在的权衡和边缘情况。
...
# 代码质量与效率
保持函数小而有用——不要仅仅为了拆分而拆分逻辑。
选择最简单的可行方案，而不是最“复杂”的。
- 如果引入新的依赖项，请说明理由并评估权衡。
```

## Tips

- 使用`@web` 引入网页作为上下文
- 使用自然语言强制Cursor 搜索代码空间 `search the codebase`
- 通过`@Add` 添加custom docs from web
...
> [!tip]
>
> https://www.jetbrains.com/zh-cn/lp/devecosystem-2023/ai/#ai_assistants
>
...
| 功能            | command               | English           | Desc                                                         |
| --------------- | --------------------- | ----------------- | ------------------------------------------------------------ |
|                 |                       |                   |                                                              |
| 新建形状        | double click canvas   |                   |                                                              |
| 多形状          | alt-shift-cursor      | clone and connect | 通过方向键快速创建形状                                       |
| 复制连接器      |                       |                   |                                                              |
| 自由连接点      | alt                   |                   |                                                              |
| 浮动/固定连接点 |                       |                   | 蓝色(float), 绿色(fixed)                                     |
| 替换形状        | shift+click<br />拖拽 |                   | 选择形状, 然后单击形状库中新的形状去替换旧有形状<br />或者shift+click实现直接替换 |
| 选中所有图形    | 􀆔+􀆝+I                 |                   |                                                              |
| 选中所有连接线  | 􀆔+􀆝+E                 |                   |                                                              |
...
- 使用等宽字体 `ui-monospace, "SF Mono"`
- [为形状和连接器设置默认样式](https://www.drawio.com/doc/faq/custom-styles-confluence-cloud)
- 连接模式 基于边缘, 基于图形中心
...
- 测量元素之间的距离: 选择元素后(click, 也可以再次点击重新确定基准元素),按住option, 然后游标悬浮(hover over)到目标元素
...
1. **生成密钥对**：在客户端，用户首先生成一对密钥，包括一个私钥和一个公钥。私钥保留在用户的设备上，不被分享；公钥可以安全地分享给任何人，特别是需要远程访问的服务器。
2. **上传公钥到服务器**：用户将公钥上传到远程服务器的`~/.ssh/authorized_keys`文件中。这一步通常通过手动编辑文件、使用`ssh-copy-id`命令或通过管理界面（如果提供）来完成。
3. **发起SSH连接**：用户从客户端发起SSH连接请求到服务器。SSH客户端使用用户的身份（如用户名）来发起请求。
4. **服务器验证公钥**：服务器接收到连接请求后，查找`~/.ssh/authorized_keys`文件，检查是否有与用户匹配的公钥。如果找到，服务器就使用该公钥创建一个随机生成的数值并加密该数值，作为一个挑战（challenge）发回给客户端。
5. **客户端使用私钥响应**：客户端收到挑战后，使用存储在本地的私钥对其进行解密，并将解密后的数值发送回服务器作为响应。
6. **服务器验证响应**：服务器接收到响应后，对比原始数值和客户端发回的数值。如果两者匹配，说明客户端持有与公钥相对应的私钥，因此验证成功。
7. **建立安全连接**：一旦认证通过，SSH会话就会被建立。所有传输的数据都将使用对称加密来保证通信的机密性和完整性。
...
# 允许root登录, 修改配置后重启ssh(不推荐)
/etc/ssh/sshd_config
PermitRootLogin yes

# 通过显式制定私钥文件进行登录, 不携带时默认使用~/.ssh/id_rsa文件来登录
ssh -i *.pem user@host
...
https://medium.com/@ysmintor/解决-macos-下-ssh-空闲一段时间后自动断开-b45867e35141
...
- `vi` 有三种基本工作模式：
    1. **命令模式**: (Normal Mode), 普通模式
        - **打开文件首先进入命令模式**，是使用 `vi` 的 **入口**
        - 通过 **命令** 对文件进行常规的编辑操作，例如：**定位**、**翻页**、**复制**、**粘贴**、**删除**……
        - 在其他图形编辑器下，通过 **快捷键** 或者 **鼠标** 实现的操作，都在 **命令模式** 下实现
    2. **末行模式(command-line mode)** —— 执行 **保存**、**退出** 等操作
...
- vim 中打开terminal `:terminal python` `:!python`
- :!python % 运行当前文件

# fswatch

```shell
fswatch -o /Users/wwfyde/Projects/rednote-publisher-extension/dist | xargs -n 1 -I {} rsync -av --delete /Users/wwfyde/Projects/rednote-publisher-extension/dist /Users/wwfyde/Documents/sync/rednote-chrome-extension
...
```shell
# 只选择音轨2, 其他则默认, 相当于删除其它音轨 
# https://gist.github.com/scottopell/10083c44642baa339d9fe1ffeab2177d
mkvmerge -o new_name.mkv -a 2 賭神.1989.mkv

# 字幕提取
mkvextract 賭神.1989.mkv tracks 3:demo.srt
...
| ------- | --------------------- | ---------------------- | ----------------------------------- |
| q       | query                 | 查询内容               | demo                                |
| cr*     | country restrict      | 限定特定国家的网站     | countryCN, countryUS                |
| gl      | **Geo Location**      | 所在区域, 指定搜索国家 | 指定位置,而不是默认定位 cn,us,uk,jp |
| hl      | **Host Language**     | 界面语言               | zh-CN,en,zh-TW                      |
...
- 选择时间瀑布, 单击选择, 双击取消选择, 护着 双指上下滑动来扩大或减少选区, 下滑到最大来选择所有选区
